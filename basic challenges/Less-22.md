# Less-22 **POST Cookie Injection- Error Based- Double Quotes - string**
TAG：POST注入、COOKIE注入、BASE64编码
## 漏洞利用 
同less20,21一样的基于cookie的注入，cookie的值也被base64b编码了  
![less22_1](images\less22_1.png)  
根据less标题提示可知，这里语句的闭合需要使用双引号了"  

简单测试  
查看数据库名:```"union select 1,2,database()#```  
Base64编码:```InVuaW9uIHNlbGVjdCAxLDIsZGF0YWJhc2UoKSM=```  

![less22_2](images\less22_2.png)  
## 源码分析 
### less22源码
```
...
...
```
其漏洞起因和漏洞利用都和LESS20相似，但是参数由双引号包裹    