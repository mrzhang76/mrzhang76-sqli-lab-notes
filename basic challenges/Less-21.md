# Less-21 **POST Cookie Injection- Error Based- complex - string**
TAG：POST注入、COOKIE注入、BASE64编码  
## 漏洞利用  
less21和less20一样从cookie方向入手，弱密码登陆后发现现在的cookie被进行base64编码了  
![less21_1](images\less21_1.png)  
将cookie解码后  
![less21_2](images\less21_2.png)  
这里可以less20的payload进行base64编码后使用  
...
echo "YOUR COOKIE : uname = $cookee and expires: " . date($format, $timestamp);
			...
			echo "<br></font>";
```
这里的cookie被base64编码了，其漏洞起因和漏洞利用都和LESS20相似  
